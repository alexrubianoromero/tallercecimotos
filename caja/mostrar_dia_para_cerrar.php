...
echo '<table border = "1" width= "95%">';
echo '<tr><td>FECHA</td><td>RECIBIDO DE </td><td>CONCEPTO</td><td>VALOR_TOTAL</td>';
echo '<td>EFECTIVO</td>';
echo '<td>T_DEBITO</td>';
...
$ingreso_gran_total = 0;
$ingreso_total_efectivo = 0;
$ingreso_total_t_debito = 0;
$ingreso_total_t_credito = 0;
...
while($recibos = mysql_fetch_assoc($consulta_recibos))
		{
			...
			echo '<td align="right">'.number_format($recibos['efectivo'], 0, ',', '.').'</td>';
			echo '<td align="right">'.number_format($recibos['t_debito'], 0, ',', '.').'</td>';
			echo '<td align="right">'.number_format($recibos['t_credito'], 0, ',', '.').'</td>';
			echo '</tr>';
			$ingreso_gran_total  		= $ingreso_gran_total + $recibos['lasumade']; 	
			$ingreso_total_efectivo  	= $ingreso_total_efectivo + $recibos['efectivo']; 	
			$ingreso_total_t_debito  	= $ingreso_total_t_debito + $recibos['t_debito']; 
			$ingreso_total_t_credito  	= $ingreso_total_t_credito + $recibos['t_credito']; 
			}
...
echo '<tr>';	
		...
		echo '<td></td>';
		echo '<td>TOTALES </td>';
		echo '<td align="right">'.number_format($ingreso_gran_total, 0, ',', '.').'</td>';
		echo '<td align="right">'.number_format($ingreso_total_efectivo, 0, ',', '.').'</td>';
		echo '<td align="right">'.number_format($ingreso_total_t_debito, 0, ',', '.').'</td>';
		echo '<td align="right">'.number_format($ingreso_total_t_credito, 0, ',', '.').'</td>';
		echo '</tr>';
echo '</table>';
...
echo '<table border = "1" width= "95%">';
echo '<tr><td>FECHA</td><td>PAGADO A  </td><td>CONCEPTO</td><td>VALOR</td>';
echo '<td>EFECTIVO</td>';
echo '<td>T_DEBITO</td>';
echo '<td>T_CREDITO</td>';
echo '</tr>';
...
$salida_gran_total = 0;
$salida_total_efectivo = 0;
$salida_total_t_debito = 0;
$salida_total_t_credito = 0;
while($recibos = mysql_fetch_assoc($consulta_recibos))
		{
			...
			echo '<td align="right">'.number_format($recibos['t_credito'], 0, ',', '.').'</td>';
			echo '</tr>';
			$salida_gran_total  	  	= $salida_gran_total + $recibos['lasumade']; 	
			$salida_total_efectivo  	= $salida_total_efectivo + $recibos['efectivo']; 	
			$salida_total_t_debito  	= $salida_total_t_debito + $recibos['t_debito']; 
			$salida_total_t_credito  	= $salida_total_t_credito + $recibos['t_credito']; 
			}
		}
echo '<tr>';	
		echo '<td></td>';
		echo '<td></td>';
		echo '<td>TOTALES </td>';
		echo '<td align="right">'.number_format($salida_gran_total, 0, ',', '.').'</td>';
		echo '<td align="right">'.number_format($salida_total_efectivo, 0, ',', '.').'</td>';
		echo '<td align="right">'.number_format($salida_total_t_debito, 0, ',', '.').'</td>';
		echo '<td align="right">'.number_format($salida_total_t_credito, 0, ',', '.').'</td>';
		echo '</tr>';
...
$queda_efectivo = $ingreso_total_efectivo  - $salida_total_efectivo;
$queda_t_debito = $ingreso_total_t_debito  - $salida_total_t_debito ;
$queda_t_credito = $ingreso_total_t_credito  - $salida_total_t_credito;
echo '<table border = "1" width= "95%">';
echo '<tr>';
echo '<td>RESUMEN </td>';
echo '<td>EFECTIVO </td>';
...
echo '<tr>';
echo '<td></td>';
echo '<td align="right">'.number_format($queda_efectivo, 0, ',', '.').'</td>';
echo '<td align="right">'.number_format($queda_t_debito, 0, ',', '.').'</td>';
echo '<td align="right">'.number_format($queda_t_credito, 0, ',', '.').'</td>';
echo '</tr>';
echo '</table>';
