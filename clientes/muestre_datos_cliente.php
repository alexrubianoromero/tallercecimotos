...
$sql_clientes = "select * from $tabla3 where idcliente = '".$_GET['idcliente']."'   and  id_empresa = '".$_SESSION['id_empresa']."'   ";
...
if ($filas  > 0)
  ...
  <tr>
   ...
   <tr>
    ...
    <td><input name="fecha_cumpleanos" id  = "fecha_cumpleanos" type="text"  value = "<?php  echo $datos[0]['fecha_cumpleanos']?> "></td>
  </tr>
  <tr>
    <td>OBSERVACIONES </td>
  ...
  <tr>
    <td ><button type ="submit"  id = "actualizar_cliente" ><h3>Actualizar</h3></button></td>
      <td><a href ="eliminar_datos_cliente.php?idcliente=<?php echo $_REQUEST['idcliente']; ?>">ELIMINAR</a></td>
