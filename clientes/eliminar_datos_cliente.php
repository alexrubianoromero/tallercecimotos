...
$consulta_eliminar= mysql_query($sql_eliminar_cliente,$conexion);
echo 'INFORMACION ELIMINADA ';
}
else
{
	echo 'EL CLIENTE TIENE VEHICULOS ASIGNADOS <BR>
	POR ESTE MOTIVO NO ES POSIBLE ELIMINARLO<BR><BR>
	DEBE ELIMINAR PRIMERO LOS VEHICULOS ASIGNADOS A EL ';
}
