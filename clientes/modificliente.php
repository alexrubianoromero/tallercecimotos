...
<Div id="contenidos">
  ...
  <tr>
    <td>Digite nombre del cliente </td>
    <td><input name="nombre" type="text" id = "nombre" size="40"></td>
  </tr>
  <tr>
    <td> <button type ="button"  id = "muestre_datos_cliente" ><h3>SIGUIENTE</h3></button></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
...
<script language="JavaScript" type="text/JavaScript">
			...
			$(document).ready(function(){
						...
						$("#muestre_datos_cliente").click(function(){
							var data =  'nombre=' + $("#nombre").val();
							$.post('muestre_coincidencias.php',data,function(a){
