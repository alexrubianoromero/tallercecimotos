...
<table width="<?php echo $ancho_tabla;  ?>" border="1">
  <tr>
    ...
    <td colspan="2"><h8></h8>
    FACTURA DIRECTA 
    <h8><?php echo $datos[0]['modelo']?></h8></td>
  </tr>
  <tr>
...
<table width="<?php echo $ancho_tabla;  ?>" border="1">
  ...
  <td width="10%"><h8>CODIGO</h8></td>
	...
	<td width="10%"><h8><!--IVA--></h8></td>
    <td width="14%"><h8>VR/TOTAL</h8></td>
  </tr>
  <?php
  
  $id_empresa = $_SESSION['id_empresa'];
    $subtotal =  muestre_items_nuevo123($datos[0]['id_orden'],$tabla100,$conexion,$id_empresa,$datos['0']['resolucion']); 
	 $completar = completar_espacios123($numero_items);
  ?>
</table>
<table width="<?php echo $ancho_tabla;  ?>" border="1">
  <tr>
...
function completar_espacios123($numero_items)
	{    
