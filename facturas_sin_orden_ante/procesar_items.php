...
$sql_grabar_item = "insert into $tabla100 (no_factura,codigo,descripcion,cantidad,total_item,valor_unitario,id_empresa,estado,porcentaje_iva,total_item_con_iva,iva)
values ('".$_POST['orden_numero']."','".$_POST['codigopan_']."','".$_POST['descripan']."','".$_POST['cantipan']."',
'".$total_item_sin_iva."','".$_POST['valor_unit']."','".$_SESSION['id_empresa']."','0','".$_POST['ivaporce']."','".$_POST['totalpan']."','".$iva."')";
