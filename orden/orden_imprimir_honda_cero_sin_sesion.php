...
<table width="95%" border="1">
    <tr><td><div align="center"> DESCRIPCION DEL TRABAJO </div></td></tr> 
   <tr> <td> <?php echo $datos_orden['observaciones'] ?></td></tr>
</table>
  
  <table width="95%" border="1">
  <tr><td><div align="center"> REPUESTOS</div> </td></tr>
  </table>
...
<?php
        $subtotal = muestre_items_local_repuestos($_REQUEST['idorden'],$tabla15,$conexion,'300',$tabla12,'R');
        $subtotal_repuestos1 = $subtotal;
?>

   
    <?php
        $subtotal = muestre_items_local_repuestos($_REQUEST['idorden'],$tabla15,$conexion,'300',$tabla12,'M');
...
<table width="95%" border="1">
  ...
  <tr>
    ...
    <td>TOTAL </td>
	<?php
	$gran_total_final =  $subtotal_repuestos1 + $subtotal_mano_obra;
