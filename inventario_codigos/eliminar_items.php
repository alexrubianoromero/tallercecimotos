...
/*
echo '<br>factupan eliminar..<br>'.$factupan;
echo '<pre>';
print_r($_GET);
echo '</pre>';
echo '<pre>';
...
item.no_factura  from $tablaitemfacinv  item 
...
//exit();
$sql_eliminar_items = "delete from  $tablaitemfacinv  where id_item = '".$_POST['eliminar_']."'";
$consulta_eliminar  = mysql_query($sql_eliminar_items,$conexion);

////tambien hay que borrar el movimiento de movimientos de inventario 
$sql_eliminar_movimiento = "delete from $tabla19  where id_item_factura_compra = '".$_POST['eliminar_']."'   ";
$consulta_eliminar = mysql_query($sql_eliminar_movimiento,$conexion);
