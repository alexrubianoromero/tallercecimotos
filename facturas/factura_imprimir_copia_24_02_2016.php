...
///////////////////////////////
                ...
                car.marca,car.modelo,car.color,car.tipo,
                 ...
                 , e.prefijo_factura as prefijo ,e.nombre as empresa ,e.identi,e.direccion,e.telefonos,e.razon_social,e.horario,e.email_empresa
...
if($tipo_factura==2)  // si es factura de venta 
              {
                 ...
                 f.valor_iva as ivafac ,f.total_factura as totalfac ,f.id_orden as id_orden,f.valor_retefuente as retefuentefac,f.resolucion as resolucion,
                  f.elaborado_por,f.tipo_factura
                 , e.resolucion as empreresolucion
                 , e.prefijo_factura as prefijo ,e.nombre as empresa ,e.identi,e.direccion,e.telefonos,o.kilometraje,o.kilometraje_cambio,e.razon_social
                from $tabla11 as f
...
<?php
  //$prefijo = '';
	   if( $datos[0]['resolucion'] == 1)
		  ...
		  $razon_social =   $datos[0]['razon_social'].' NIT. '.$datos[0]['identi'];//  'SERVI-MARTHA NIT. 52.297.022-6';
		  $palabra_iva = 'IVA';
         ...
         // $prefijo = $datos[0]['prefijo'];
	  		...
	  		$nombre_documento  =  'COTIZACION  No ';
	  		  $razon_social = '';	
			  $palabra_iva = '';
			   $palabra_retefuente = '';
			} 
...
<div id="Layer2"><img src="<?php  echo $ruta_imagen    ?>" width="268" height="80"></div>
<div id="Layer3"><img src="<?php  echo $ruta_imagen2    ?>" width="235" height="32"></div>
<br>
<div id="Layer4">
  <h7>
