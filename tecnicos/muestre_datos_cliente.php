...
if ($filas  > 0)
  ...
  <tr>
   ...
   <tr>
    <td>PORCENTAJE </td>
    <td><input name="porcentaje" id  = "porcentaje" type="text"  value = "<?php  echo $datos[0]['porcentaje_nomina']?>" size="4px" >%</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  ...
  <tr>
    ...
    <td><a href ="eliminar_datos_cliente.php?idcliente=<?php echo $_REQUEST['idcliente']; ?>">ELIMINAR TECNICO</a></td>
    </tr>
  <tr>
    <td colspan="2">&nbsp;</td>
  </tr>
