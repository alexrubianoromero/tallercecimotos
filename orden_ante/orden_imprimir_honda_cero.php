...
<table width="<?php echo $ancho_tabla; ?>" border="0">
  <tr>
    <td width="17%"><img src="../logos/motospeed.png" width="210" height="168"></td>
...
<?php
$subtotal = muestre_items_local_repuestos($_REQUEST['idorden'],$tabla15,$conexion,$_SESSION['id_empresa'],$tabla12,'M');
